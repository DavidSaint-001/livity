...
const Story = () => {
    return (
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 py-20 mt-10 font-sans">
            ...
            {/* NARRATIVE SECTION 1*/}
            <div className="grid md:grid-cols-2 gap-16 items-center mb-23">
                <motion.div
            ...
            {/* NARRATIVE SECTION 2 */}
            <div className="grid md:grid-cols-2 gap-16 items-center flex-row-reverse mb-32">
                <div className="space-y-6 max-w-md md:order-1 order-2 md:ml-auto text-right">
            ...
            <motion.div
                ...
                >
                    <p className="text-2xl font-light italic text-gray-400 max-w-2xl mx-auto">
