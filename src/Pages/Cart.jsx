...
const Cart = () => {
  // Destructure with the correct variant-aware arguments
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
          {cartItems.map((item) => (
            ...
            <div key={`${item.id}-${item.selectedColor}-${item.selectedSize}`} className="border border-gray-100 p-6 relative flex flex-col items-center bg-white shadow-sm">
              <button 
                // Updated to pass variant info
              ...
              <div className="w-full aspect-[4/5] bg-[#F9F9F9] mb-6 overflow-hidden flex items-center justify-center">
                <img 
          ...
          <div className="border border-gray-100 bg-white sticky top-32 shadow-sm">
            ...
            <div className="px-8 pb-8 border-t border-gray-100 pt-6">
                ...
                <textarea 
                  ...
                  className="w-full border border-gray-100 p-4 h-28 text-xs focus:outline-none focus:border-black resize-none placeholder:text-gray-300 transition-all bg-gray-50" 
                />
            </div>
            ...
            <div className="px-8 pb-8">
              <button 
                ...
                className="w-full bg-black text-white py-5 text-[11px] uppercase font-bold tracking-[0.25em] hover:bg-gray-800 transition-colors shadow-lg"
              >
                Proceed to Checkout
              </button>
